...
namespace AGoT.AGoTDB.Forms
{
  partial class DeckBuilderForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.treeViewDeck = new CardTreeView();
      ...
      this.treeViewSide = new CardTreeView();
      ...
      this.cbAgenda = new System.Windows.Forms.ComboBox();
      ...
      // cbAgenda
      // 
      this.cbAgenda.AccessibleDescription = null;
      this.cbAgenda.AccessibleName = null;
      resources.ApplyResources(this.cbAgenda, "cbAgenda");
      this.cbAgenda.BackgroundImage = null;
      this.cbAgenda.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.cbAgenda.Font = null;
      this.cbAgenda.FormattingEnabled = true;
      this.cbAgenda.Items.AddRange(new object[] {
                                                  resources.GetString("cbAgenda.Items"),
                                                  resources.GetString("cbAgenda.Items1")});
      this.cbAgenda.Name = "cbAgenda";
      this.cbAgenda.SelectedIndexChanged += new System.EventHandler(this.cbAgenda_SelectedIndexChanged);
      // 
      // tbAuthor
      // 
    ...
    private System.Windows.Forms.ComboBox cbAgenda;
    private System.Windows.Forms.SplitContainer splitContainer2;
    private System.Windows.Forms.SplitContainer splitContainer1;
    private CardTreeView treeViewDeck;
    ...
    private CardTreeView treeViewSide;
  }
}